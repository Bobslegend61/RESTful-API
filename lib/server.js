...
server.init = () => {
    ...
    server.httpServer.listen(httpPort, () => console.log(`The server is listening on port ${ httpPort }`));

    // Start the HTTPS server
    server.httpsServer.listen(httpsPort, () => console.log(`The server is listening on port ${ httpsPort }`));
}
